...
function initMap() {
    ...
    //Pickup points
    var pickupPoint = {
        url: "images/map-assets/pickup-point.svg", // url
        scaledSize: new google.maps.Size(45, 45), // scaled size
        origin: new google.maps.Point(0, 0), // origin
        anchor: new google.maps.Point(0, 0) // anchor
    }
    ...
    //bus stage
    var stage = {
        url: "images/map-assets/stage.svg", // url
        scaledSize: new google.maps.Size(45, 45), // scaled size
        origin: new google.maps.Point(0, 0), // origin
        anchor: new google.maps.Point(0, 0) // anchor
    }
    ...
    */
    ...
    //inactive agent
    addMarker({
        coords: { lat: -1.29589, lng: 36.8486023 },
    ...
    addMarker({
        ...
        <p class="text-info"><strong>Two Pending Pickups</strong></p>      
        </div>
        </div>`
    });
    ...
    function geocode(e) {
        ...
        axios.get('https://maps.googleapis.com/maps/api/geocode/json', {
                params: {
                    address: location,
                    key: 'AIzaSyCGotsWnW4C3KL3O-tNNy5KM0296gdVhfE'
                }
    ...
    function reverseGeocoding(Latitude, longitude) {
        const KEY = "AIzaSyCGotsWnW4C3KL3O-tNNy5KM0296gdVhfE";
        const LAT = -1.270102;
